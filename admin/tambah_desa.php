    ...
    <div class="min-h-screen py-6">
        <div class="max-w-xl mx-auto animate-fade-in">
            <div class="bg-gradient-to-r from-primary to-primary-600 text-white rounded-2xl p-5 shadow-lg flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl font-bold leading-tight">Tambah Desa Baru</h1>
                    <p class="text-white/80 text-sm">Masukkan informasi desa dengan benar</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-5 mt-4 glass-effect">
                <form method="post" class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nama_desa" required class="w-full rounded-xl border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Kecamatan</label>
                        <input type="text" name="kecamatan" required class="w-full rounded-xl border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" />
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Kepala Desa</label>
                        <input type="text" name="kepala_desa" placeholder="Opsional" class="w-full rounded-xl border border-gray-200 px-3 py-2 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all" />
                    </div>
